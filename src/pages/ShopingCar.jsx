                    ...
                    <div className="flex-[1]">
                        ...
                        <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
                            ...
                            <div className="text-sm md:text-md py-5 border-t mt-5">
                                ...
                                adipisicing elit. Aliquid quae quidem mollitia
                                eius. Debitis a voluptatibus omnis corrupti
                                repellendus. Saepe atque totam eaque veritatis
                                deleniti voluptates maxime iure ut excepturi,
                                eveniet at expedita aliquam reiciendis illum sed
                                iste? Dolorum, qui!
                            </div>
                        </div>
